...
CREATE TABLE empresas(
	...
	CONSTRAINT fk_emp_equipamentos FOREIGN KEY(id_emp_equipamentos) REFERENCES equipamentos_emp(id_equipamentos_emp)
)ENGINE="InnoDB";
...
ALTER TABLE empresas 
	ADD CONSTRAINT fk_emp_equipamentos FOREIGN KEY(id_emp_equipamentos) 
			REFERENCES equipamentos_emp(id_equipamentos_emp);